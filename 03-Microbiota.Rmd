...
kable(rankindices, col.names = c("Euclidean", "Manhattan", "Bray–Curtis", "Jaccard", "Kulczynski", "Sponge species", "Normalisation"), booktabs = T, 
    caption = "Rank correlation between dissimilarity indices and gradient separation.", 
    row.names = FALSE) %>% 
...
```{r relative-abundance, fig.cap="Rel ABDC Phylum"}
library(vegan)
library(reshape2)
library(phyloseq)
library(picante)
