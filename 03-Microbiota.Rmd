...
k <- vegdist(micro_ds$gb)
mat_col <- data.frame(group = gb_md$depth_category)
rownames(mat_col) <- gb_md$unified_ID
...
k <- vegdist(micro_ds$sf)
mat_col <- data.frame(group = sf_md$depth_category)
rownames(mat_col) <- sf_md$unified_ID
...
k <- vegdist(micro_ds$wb)
mat_col <- data.frame(group = wb_md$depth_category)
rownames(mat_col) <- wb_md$unified_ID
